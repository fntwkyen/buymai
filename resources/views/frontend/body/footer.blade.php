        ...
        <div class="container">
            ...
            <div class="col-xs-12 col-sm-6 no-padding">
                <div class="clearfix payment-methods">
                    <ul>
                        <li><img src="{{ asset('frontend/assets/images/payments/.1png') }}" alt=""></li>
                        <li><img src="{{ asset('frontend/assets/images/payments/.2png') }}" alt=""></li>
                        <li><img src="{{ asset('frontend/assets/images/payments/.3png') }}" alt=""></li>
                        <li><img src="{{ asset('frontend/assets/images/payments/.4png') }}" alt=""></li>
                        <li><img src="{{ asset('frontend/assets/images/payments/.5png') }}" alt=""></li>
                    </ul>
                </div>
                <!-- /.payment-methods -->
            </div>
